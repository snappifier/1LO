...
export default function Rekrutacja() {
    return <div className="font-[montserrat] flex flex-col w-full h-max gap-5 px-[10vw] pb-10 mt-30 md:gap-10 bg-white">
        ...
        <div className="flex flex-col gap-10 md:flex-row md:gap-15 justify-center">
            <img className="h-full"  src={rekrutacjaBaner} />
            <div className="h-max flex flex-col gap-5 md:gap-10 justify-center">
                <p className="w-max font-[meow_script] hidden md:block md:text-6xl lg:text-7xl">Jestem w pierwszym</p>
                <p className="font-[montserrat] font-medium w-full text-wrap md:text-xl lg:text-2xl">Serdecznie zapraszamy wszystkich absolwentów szkół podstawowych do dołączenia do naszej wyjątkowej społeczności!</p>
                <p className="font-[montserrat] font-regular w-full text-wrap md:text-xl lg:text-2xl ">
