...
export const AktualnosciHome = () => {
    ...
    return (
        <>
            <div className="font-[poppins] bg-white  flex flex-col w-full h-max gap-5 mt-20 items-center">
                ...
                <div className="w-full flex flex-wrap gap-10 items-start justify-center px-[12vw] pt-10 pb-15 ">
                    {newsSection.map((news, index) => (
                        <motion.div
                            className="h-130 flex flex-col gap-2 md:w-2/7 hover:cursor-pointer rounded-lg shadow-xl/20 overflow-hidden bg-white"
                            whileHover={{y: -10}}
                        >
                            ...
                            <div className="w-full flex justify-center items-center pt-4">
                                <p className="text-sm w-5/6 font-[poppins] text-black">{news.post} | {news.author}</p>
                            </div>
                            <div className="w-full flex justify-center items-center">
                                <p className="w-5/6 font-[poppins] font-semibold text-black text-xl">{news.title}</p>
                            </div>
                            <div className="w-full flex justify-center">
                                <div className="w-5/6 h-[1px] bg-black/40"></div>
                            </div>
                            <div className="w-full  overflow-hidden py-4 flex justify-center">
                                <p className="w-5/6 font-[poppins] text-black">Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div className="w-full flex justify-center items-center">
                                <p className="w-5/6 font-[poppins] font-semibold text-black text-sm">Zobacz więcej</p>
                            </div>
                ...
                <Link to={"/"}>
                    <button
                        className="px-10 py-4 w-max h-max bg-[#3077BA] font-medium text-white cursor-pointer hover:bg-[#4034BA] rounded-md shadow-md/20">Dowiedz
                        sie wiecej
                    </button>
                </Link>
