...
export default function Banner() {
    return (<>
        <div className="relative w-full h-[70vh] md:h-[65vh] flex items-center justify-center drop-shadow-lg/60">
            ...
            <div className="flex md:relative md:flex justify-between md:-bottom-[calc(0vh-45px)] left-1/2 translate-x-[-50%] min-w-80 max-w-280 gap-8 h-[90px] px-10">
                <motion.div
                    whileHover={{scale: 1.05}}
                    transition={{ duration: 0.2, ease: "easeOut" }}
                    className="bg-[#3077BA] h-full w-full drop-shadow-lg/30 rounded-xl flex flex-col justify-center items-center text-white cursor-pointer text-wrap">
                ...
                <motion.div
                    whileHover={{scale: 1.05}}
                    transition={{ duration: 0.2, ease: "easeOut" }}
                    className="bg-[#3077BA] h-full w-full drop-shadow-lg/30 rounded-xl flex flex-col justify-center items-center text-white cursor-pointer ">
