            ...
            <div className="font-[montserrat] flex flex-col w-full h-max gap-5 px-[12vw] pb-20 mt-20 md:gap-10 bg-white">
                ...
                <div className="w-full flex flex-wrap gap-10 items-start justify-center">
                    {newsSection.map((news, index) => (
                        <motion.div className=" h-[55vh] flex flex-col gap-2 w-2/7 rounded-lg shadow-lg overflow-hidden "
                        whileHover={{y: -10}}
                        >
                            ...
                            <div className="w-full flex justify-center items-center">
                                <p className="w-5/6 font-[Montserrat] text-black">{news.post} | {news.author}</p>
                            </div>
                            <div className="w-full flex justify-center items-center">
                                <p className="w-5/6 font-[golos_text] font-bold text-black text-xl">{news.title}</p>
                            </div>
                            <div className="w-full flex justify-center"><div className="w-5/6 h-[1px] bg-black/40"></div></div>
                            <div className="w-full  overflow-hidden px-2 py-5 flex justify-center">
