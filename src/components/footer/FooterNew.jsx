...
const navigation = {
    ...
    social: [
        ...
        },
        {
            ...
            icon: (props) => (
                <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
                    <path d="M12 6.5A2.5 2.5 0 0 1 14.5 9a2.5 2.5 0 0 1-2.5 2.5A2.5 2.5 0 0 1 9.5 9A2.5 2.5 0 0 1 12 6.5M12 2a7 7 0 0 1 7 7c0 5.25-7 13-7 13S5 14.25 5 9a7 7 0 0 1 7-7m0 2a5 5 0 0 0-5 5c0 1 0 3 5 9.71C17 12 17 10 17 9a5 5 0 0 0-5-5" />
                </svg>
            ),
        },
    ],
        ...
        <footer className="bg-[#3077BA]  w-full h-max font-[poppins] overflow-x-clip">
            <div className="mx-auto max-w-[98%] overflow-visible  py-6 sm:py-6 lg:px-8 flex flex-col">
                ...
                <div className="w-full h-max flex items-center justify-center py-2">
                    ...
                    <motion.img src={images?.["logo_thumbnail"] ? images["logo_thumbnail"] : logo}  alt="logo" className="select-none h-15 w-15   drop-shadow-lg/20" whileHover={{scale: 1.1}} whileTap={{scale: 1}}/>
                    <p className=" text-center text-gray-100 font-[poppins] text-xs sm:text-xs lg:text-md max-w-2/3 font-light whitespace-normal break-words hyphens-auto">I Liceum Ogólnokształcące im. Jana Zamoyskiego w Zamościu </p>

                        <img src={images?.["godlo_thumbnail"] ? images["godlo_thumbnail"] : godlo} alt="Godło" className=" select-none h-15 w-auto object-contain" />
                    </div>
                </div>
                ...
                >
                    {navigation.main.map((item) => (
                        <Link
                            key={item.name}
                            to={item.href}
                            className="text-gray-100 hover:text-white select-none"
                        >
                            {item.name}
                        </Link>
                    ))}
                        ...
                        if (item.name === "Telefon") {
                            return (
                                <div key="Telefon" className="relative group">
                                    {/* tooltip z numerem */}
                                    <div className="pointer-events-none absolute -top-10 left-1/2 -translate-x-1/2 translate-y-2 opacity-0 transition-all duration-200 group-hover:translate-y-0 group-hover:opacity-100 z-10">
                                        <span className="rounded-md bg-white/90 px-3 py-1.5 text-xs font-medium text-[#3077BA] shadow whitespace-nowrap">
                                          {PHONE_NUMBER}
                                        </span>
                                    </div>
                                    ...
                                    {copied && (
                                        ...
                                        >
                                          <span className="rounded-md bg-green-500/90 px-2 py-1 text-xs font-semibold text-white shadow">
                                            Skopiowano!
                                          </span>
                                        </motion.div>
                                    )}
