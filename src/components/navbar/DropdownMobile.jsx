...
const DropdownMobile = ({isOpen, setIsOpen}) => {
    ...
    const m_uczen = useSuspenseQuery({
        queryKey: ["uczen"],
        queryFn: () =>
            get(
    ...
    const m_szkola = useSuspenseQuery({
        queryKey: ["szkola"],
        queryFn: () =>
            get(
    ...
    const m_aktualnosci = useSuspenseQuery({
    ...
    const m_dokumenty = useSuspenseQuery({
        queryKey: ["dokumenty"],
        queryFn: () =>
            get(
    ...
    const uczen = m_uczen.data?.data || [];
    const szkola = m_szkola.data?.data || [];
    const aktualnosci = m_aktualnosci.data?.data || [];
    const dokumenty = m_dokumenty.data?.data || [];
